...
while not buyButton:
    ...
    try:
     addToCartBtn = addButton = browser.find_element(By.XPATH, "//button[contains(@class,'BaseButton-sc-3v3oog-0 ButtonPrimary-sc-9wgfzx-0 styles__StyledPrimaryButton-sc-1f2lsll-0 eVHdWy JRFKP bebHXQ')]")
...
while buyButton:
     ...
     browser.find_element(By.XPATH, "//input[contains(@class,'Input__StyledInput-sc-1hug1ai-0 sc-bBrOnJ bhhAF')]") .send_keys(user_email)

     browser.find_element(By.XPATH, "//input[contains(@id,'password')]") .send_keys(user_password)
